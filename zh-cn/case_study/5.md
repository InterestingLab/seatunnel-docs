...
2. 安装Waterdrop
3. 配置Waterdrop
以下是简易步骤，具体安装可以参照[Quick Start](https://interestinglab.github.io/earth-fleet-docs/#/zh-cn/v1/quick-start)
...
如果你对这两个也感兴趣的话，可以阅读我们以前发布的文章《[如何快速地将Hive中的数据导入ClickHouse](https://interestinglab.github.io/earth-fleet-docs/#/zh-cn/v1/case_study/2)》、
《[优秀的数据工程师，怎么用Spark在TiDB上做OLAP分析](https://interestinglab.github.io/earth-fleet-docs/#/zh-cn/v1/case_study/4)》、
《[如何使用Spark快速将数据写入Elasticsearch](https://interestinglab.github.io/earth-fleet-docs/#/zh-cn/v1/case_study/3)》
...
<table><tr>
<td><img src="/zh-cn/images/wechat-qrcode/garyelephant.jpeg" border=0 width=150 height=150></td>
<td><img src="/zh-cn/images/wechat-qrcode/kid-xiong.jpeg" border=0 width=150 height=150></td>
</tr></table>
